...
//**************************************************
#define REG_ACCESS_READ   0x00
#define REG_ACCESS_WRITE  0x80
#define REG_ADDRESS_MASK  0x7F
#define _READ_ACCESS(x)   ((x & REG_ADDRESS_MASK) | REG_ACCESS_READ)
#define _WRITE_ACCESS(x)  ((x & REG_ADDRESS_MASK) | REG_ACCESS_WRITE)
